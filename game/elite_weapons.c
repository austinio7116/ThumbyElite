...
const WeaponDef k_weapons[WPN_COUNT] = {
    ...
    [WPN_HOMING]    = { "HOMING",  32, 1.10f, 2.0f,  190, 2600, 1.7f, 18, 2, 10, RGB565C(255, 120, 200) },
    [WPN_FLAK]      = { "FLAK",     6, 0.65f, 5.0f,  420,  400,  0,   0, 2, 60, RGB565C(255, 190, 110) },
    ...
    [WPN_MINING]    = { "MINING",   3, 0.09f, 1.4f,    0,  350,  0,   0, 1,  0, RGB565C(255, 200,  90) },
};
