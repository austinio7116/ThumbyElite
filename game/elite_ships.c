...
const HullDef k_hulls[N_HULLS] = {
    ...
    { "SKIFF",     &mesh_shuttle,      900, 1, {1, 0, 0},   12,  1, 1,   85,  40, 1.5f,   70,  50,  6.5f, 3, 1, 0 },
    { "DART",      &mesh_courier,     3200, 1, {2, 0, 0},   4,  1, 1,  150,  85, 2.3f,   60,  55, 7.0f, 2, 1, 0 },
    ...
    { "PACK MULE", &mesh_lighthauler, 7000, 1, {1, 0, 0},  48,  1, 2,   80,  35, 1.2f,  110,  70,  7.5f, 6, 1, 0 },
